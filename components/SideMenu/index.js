...
function SideMenu({
  sideMenu: { menuAnimateState, setMenuAnimateState, handleLogout, history },
}) {
  return (
    <>
      {menuAnimateState && (
        <TouchableOpacity
          onPress={() => setMenuAnimateState(false)}
          style={{
            position: "absolute",
            zIndex: 100,
            top: 0,
          ...
          >
            <View>
              ...
              <View
                style={{
                  ...
                  borderBottomWidth: 1,
                  width: 50,
                  marginLeft: dimensions.width * 0.33 - 25,
                }}
              />
            ...
            <View>
              ...
              <View style={{ flexDirection: "row", marginTop: 30 }}>
                ...
                <TouchableOpacity
                  onPress={() => history.push("/DisclaimerPage")}
                  style={{
