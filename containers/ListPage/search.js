...
function Search({
  ...
  return (
    <>
      {searchAnimateState && (
        <TouchableOpacity onPress={clickOverlay} style={searchStyle.overlay} />
      )}
      <PosedKeyboard
        pose={keyboard ? "open" : "close"}
        behavior="height"
        enabled
      ...
      >
        <SearchView
          ...
          style={{
            ...searchStyle.searchView,
            width: searchAnimateState ? "100%" : 70,
          }}
        >
          <SearchInputView
          ...
          <TouchableOpacity
            ...
            style={{
              ...searchStyle.button,
              elevation: searchAnimateState ? 21 : 0,
            }}
          >
            <Image
